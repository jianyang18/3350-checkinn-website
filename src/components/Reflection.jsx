...
const iterations = [
	...
	},
	{
		id: 'i3',
		label: 'Iteration 3',
		subtitle: 'Placeholder subtitle. Replace this.',
		summary: 'Placeholder summary for Iteration 3. Replace this with a short overview of the iteration.',
		shipped: ['Placeholder. Replace with a short bullet about what was shipped.'],
		feedback: ['Placeholder. Replace with a short bullet about feedback received.'],
		changed: ['Placeholder. Replace with a short bullet about what was changed.'],
		learned: ['Placeholder. Replace with a short bullet about what was learned.'],
	...
	},
	{
		...
		summary: 'Placeholder summary. Replace this with a short closing reflection on the whole project.',
		shipped: null,
		feedback: null,
		changed: null,
		learned: null,
		...
		testingStrategy: [
			"Mockito for service-layer unit tests. Each service method runs in isolation against mocked repositories, so the business logic is tested without touching a database.",
			"Real SQLite in memory for integration tests. The repository implementations run against an actual database, so a typo in a WHERE clause shows up in CI instead of in production.",
			...
			"127 tests pass on every commit. Business-layer coverage sits at 99%.",
		],
		remarks: null,
	},
];
