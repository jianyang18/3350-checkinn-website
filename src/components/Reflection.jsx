...
const iterations = [
  ...
  },
  {
    ...
    evidence: [
      ...
      "Every object class is now pure data",
      "127 tests pass on every commit",
  ...
  },
  {
    ...
    summary:
      "Placeholder summary for Iteration 3. Replace this with a short overview of the iteration.",
...
export default function Reflection() {
  ...
  const populatedSectionCount = sectionDefs.filter(
    ({ key }) => active[key] && active[key].length > 0
  ).length;
      ...
      <div className="container">
        <div className="max-w-2xl mb-12">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            Pick an iteration to see what we built, what came back from the
            marker, and what we did about it.
          </p>
        </div>
        ...
        <div key={active.id} className="animate-fade-up">
          <Card className="bg-background mb-5">
            <CardContent className="p-8">
              ...
              <p className="text-xl text-foreground leading-relaxed max-w-3xl mb-6">
                {active.summary}
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-5 mb-5">
                ...
                {active.remarks && (
                  <Card
                    className={cn(
                      "bg-background",
                      remarksSpansFull && "md:col-span-2"
                    )}
                  >
                    <CardHeader>
